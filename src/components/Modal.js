        ...
        <div className="fixed bg-white p-5 top-1/4 rounded-lg text-gray-700 shadow-lg w-11/12 sm:w-2/4 sm:max-w-sm">
          ...
          <div className="modal-body">
            ...
            <div className={ url.length > 0 ? "" : "hidden" }>
              ...
              <button onClick={copyToClipboard} title="Copy link to clipboard" className="hidden md:inline text-white ml-3 py-1 px-4 copy-link rounded-md bg-green-500 hover:bg-green-600 active:bg-green-700"><i className="wsico-clipboard"></i></button>
              ...
              <button onClick={copyToClipboard} className="mobile-button md:hidden w-full text-white mt-4 py-2 copy-link rounded-md bg-green-500 hover:bg-green-600 active:bg-green-700">Copy <i className="wsico-clipboard"></i></button>
